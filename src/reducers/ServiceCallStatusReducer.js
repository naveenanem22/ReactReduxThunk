...
import {MODAL_MESSAGE_UPDATE_TICKET, MODAL_MESSAGE_UPDATE_TICKET_FAILURE, MODAL_MESSAGE_UPDATE_TICKET_SUCCESS} from '../actions/ActionTypes';
...
export function serviceCallStatusReducer(state = {}, action) {
    switch (action.type) {
        ...
        case MODAL_MESSAGE_UPDATE_TICKET:
            return {
                ...state, modalMessageAndUpdateTicketAPI: { requested: true, success: false, error: false }
            }
        case MODAL_MESSAGE_UPDATE_TICKET_SUCCESS:
            return {
                ...state, modalMessageAndUpdateTicketAPI: { requested: false, success: true, error: false }
            }
        case MODAL_MESSAGE_UPDATE_TICKET_FAILURE:
            return {
                ...state, modalMessageAndUpdateTicketAPI: { requested: false, success: false, error: true }
            }
